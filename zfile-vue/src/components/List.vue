      ...
      <el-table-column
        ...
        <template #header v-if="$store.getters.showLinkBtn">
          ...
          <el-tooltip class="item" effect="dark" content="批量生成直链" placement="top">
            <i @click.stop="openBatchCopyLinkDialog"
               class="el-icon-copy-document operator-btn hidden-xs-only zfile-margin-left-5"></i>
          </el-tooltip>
        </template>
        <template #default="scope">
      ...
      <el-row v-if="currentCopyLinkRow.row">
        ...
        <el-col :span="12" :xs="24" class="zfile-dialog-link-result-info">
          <el-form>
            ...
            <el-form-item>
              <el-input disabled prefix-icon="el-icon-coin"
                        v-bind:value="currentCopyLinkRow.row.size | fileSizeFormat"></el-input>
            </el-form-item>
            <el-form-item v-if="$store.getters.showLinkBtn && $store.getters.showPathLink">
              <el-input prefix-icon="el-icon-link" type="small" v-model="currentCopyLinkRow.directlink">
                <el-tooltip #append class="item" effect="dark" content="复制" placement="bottom">
                  <el-button @click="copyText(currentCopyLinkRow.directlink)" type="small"
            ...
            <el-form-item v-if="$store.getters.showLinkBtn && $store.getters.showShortLink">
              <el-input prefix-icon="el-icon-link" type="small" v-model="currentCopyLinkRow.link">
                <el-tooltip #append class="item" effect="dark" content="复制" placement="bottom">
                  <el-button @click="copyText(currentCopyLinkRow.link)" type="small"
                             icon="el-icon-copy-document"></el-button>
                </el-tooltip>
              </el-input>
            </el-form-item>
        ...
        <el-table-column label="文件名称" prop="name">
          <template #header>
            ...
            <el-tooltip class="item" effect="dark" content="批量复制" placement="top">
              <i @click.stop="batchCopyLinkField('name')"
                 class="el-icon-copy-document operator-btn zfile-margin-left-5"></i>
            </el-tooltip>
          </template>
        </el-table-column>
        <el-table-column v-if="$store.getters.showLinkBtn && $store.getters.showShortLink" label="短链" width="250px"
                         prop="link1">
          <template #header>
            <span>短链</span>
            <el-tooltip class="item" effect="dark" content="批量复制" placement="top">
              <i @click.stop="batchCopyLinkField('link1')"
                 class="el-icon-copy-document operator-btn zfile-margin-left-5"></i>
            </el-tooltip>
          </template>
        </el-table-column>
        <el-table-column v-if="$store.getters.showLinkBtn && $store.getters.showPathLink" label="直链" width="350px"
                         show-overflow-tooltip prop="link2">
          <template #header>
            <span>直链</span>
            <el-tooltip class="item" effect="dark" content="批量复制" placement="top">
              <i @click.stop="batchCopyLinkField('link2')"
                 class="el-icon-copy-document operator-btn zfile-margin-left-5"></i>
            </el-tooltip>
          </template>
        </el-table-column>
